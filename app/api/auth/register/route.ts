...
export async function POST(request: NextRequest) {
  ...
  try {
    (InsertUserModel as any).email = email;
    (InsertUserModel as any).position = position.toLowerCase();
    (InsertUserModel as any).fullname = fullname;
    (InsertUserModel as any).phone = phone;
    (InsertUserModel as any).license_number = license_number;
    console.log("UserModel from request:", InsertUserModel)
  } catch (error: any) {
