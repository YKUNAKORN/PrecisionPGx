...
export async function GetAllQualityMetrics(): Promise<QualityResponse> {
...
export async function UpdateQualityMetrics(id: string, row: QualityMetricRow): Promise<QualityResponse> {
...
export async function GetQualityById(id: string): Promise<QualityResponse> {
...
export async function CreateQualityMetrics(row: QualityMetricRow): Promise<QualityResponse> {
...
export async function CreateQualityMetricsAndUpdateReport(row: QualityMetricRow, reportId: string): Promise<QualityResponse> {
    const { data, error } = await Create(db, "quality", row);
    if (error) {
        return { data: null, error: error }; //for User
    }
...
export async function DeleteQualityMetrics(id: string): Promise<QualityResponse> {
...
export async function GetAllQualityMetricsPercent(): Promise<QualityResponse> {
    const { data, error } = await GetAll(db, "quality");
    let pass = 0;
    let fail = 0;
    let warning = 0;
