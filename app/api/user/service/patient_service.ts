...
export async function CreatePatient(row: any): Promise<{ data: any; error: any }> {
...
export async function GetPatientById(id: string): Promise<{ data: any; error: any }> {
...
export async function UpdatePatient(id: string, row: any): Promise<{ data: any; error: any }> {
...
export async function DeletePatient(id: string): Promise<{ data: any; error: any }> {
