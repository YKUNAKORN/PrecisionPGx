...
export async function CreateSpecimen(row: SpecimenRow): Promise<SpecimenResponse> {
...
export async function UpdateSpecimen(id: string, row: SpecimenRow): Promise<SpecimenResponse> {
...
export async function DeleteSpecimen(id: string): Promise<SpecimenResponse> {
