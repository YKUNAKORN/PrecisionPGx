...
export async function CreateNote(row: any): Promise<any> {
...
export async function UpdateNoteByID(id: string, row: any): Promise<any> {
...
export async function DeleteNoteByID(id: string): Promise<any> {
