...
export async function QueryAllRules(): Promise<RuleResponse> {
    try {
        ...
        const dataWithIndex = response.data.map((rule: any, index: number) => ({
            row_index: index,
            ...rule
        }));
...
export async function QueryRuleByRowIndex(rowIndex: number): Promise<RuleResponse> {
    try {
...
export async function QueryRulesById(id: string): Promise<RuleResponse> {
    try {
...
export async function QueryAllRulesByIndex(index: number): Promise<RuleResponse> {
    try {
...
export async function QueryRule(ruleID: string, index: number): Promise<RuleResponse> {
    try {
...
export async function InsertRule(InsertRuleModel: any): Promise<RuleResponse> {
    try {
...
export async function UpdateRule(ruleID: string, UpdateRuleModel: any): Promise<RuleResponse> {
    try {
...
export async function DeleteRule(ruleID: string): Promise<RuleResponse> {
    try {
