import { Fridge, ReportCapacity, FridgeType, ReportCapacityType } from '@/lib/model/Fridge';
import { CreateClientSecret } from "@/lib/supabase/client";
import { GetAll, GetById, Update, Create, Delete } from "@/lib/supabase/crud";

const db = CreateClientSecret();

export async function GetAllFridges(): Promise<{ data: FridgeType[] | null; error: any }> {
...
export async function GetFridgeById(id: string): Promise<{ data: FridgeType | null; error: any }> {
...
export async function UpdateFridge(id: string, row: any): Promise<{ data: FridgeType[] | null; error: any }> {
...
export async function IncreaseFridgeItem(id: string, updated_data: any): Promise<{ data: any; error: any }> {
...
export async function DecreaseFridgeItem(id: string, updated_data: any): Promise<{ data: any; error: any }> {
    const { data, error } = await GetFridgeById(id);
    if (error) {
        return { data: null, error: error }; //for User
    }
...
export async function DeleteFridge(id: string): Promise<{ data: any; error: any }> {
...
export async function CreateFridge(row: any): Promise<{ data: any; error: any }> {
...
export async function CalculateFridge(): Promise<{ data: ReportCapacityType | null; error: any }> {
