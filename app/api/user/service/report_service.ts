...
export async function CreateReport(inputReportModel: InputReportModel): Promise<ReportResponse> {
    try {
...
export async function UpdateReportByID(id: string, row: any): Promise<ReportResponse> {
...
export async function DeleteReportByID(id: string): Promise<ReportResponse> {
...
export async function GetAllReportsDashboard(): Promise<ReportResponse> {
...
export async function EditReportByID(id: string, body: any): Promise<ReportResponse> {
...
export async function Pharm_verify(report_id: string, pharmacist_id: string): Promise<ReportResponse> {
...
export async function UpdateStatusReportById(id: string, statusupdate: any): Promise<ReportResponse> {
