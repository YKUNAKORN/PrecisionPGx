...
export async function GET(req, { params }) {
    try {  
        ...
        if (error || !data) {
            ...
            (ResponseModel as any).message = error?.message || 'Patient not found';
...
export async function PUT(req, { params }) {
    try {
        ...
        (ResponseModel as any).status = '200';
        (ResponseModel as any).message = 'Patient updated successfully';
        (ResponseModel as any).data = data;
...
export async function DELETE(req, { params }) {
    try {
        ...
        (ResponseModel as any).status = '200';
        (ResponseModel as any).message = 'Patient deleted successfully';
        (ResponseModel as any).data = data;
