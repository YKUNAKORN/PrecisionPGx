...
export async function POST(req: NextRequest): Promise<NextResponse> {req) {
...
export async function PUT(req: NextRequest): Promise<NextResponse> {req) {
...
export async function DELETE(req: NextRequest): Promise<NextResponse> {req) {
