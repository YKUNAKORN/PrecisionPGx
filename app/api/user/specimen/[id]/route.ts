...
export async function GET(req: NextRequest): Promise<NextResponse> {req, { params }) {
    try {  
...
export async function PUT(req: NextRequest): Promise<NextResponse> {req, { params }) {
    try {
        const { id } = await params
...
export async function DELETE(req: NextRequest): Promise<NextResponse> {req, { params }) {
    try {
        const { id } = await params
