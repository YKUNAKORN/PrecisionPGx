...
export async function GET(req, { params }) {
    try {  
        ...
        if (!storaged) {
            ...
            (ResponseModel as any).message = 'Storaged not found';
        ...
        (ResponseModel as any).data = storaged;
...
export async function PUT(req, { params }) {
    try {
        ...
        (ResponseModel as any).status = '200';
        (ResponseModel as any).message = 'Storage updated successfully';
...
export async function DELETE(req, { params }) {
    try {
        ...
        (ResponseModel as any).status = '200';
        (ResponseModel as any).message = 'Storage deleted successfully';
        (ResponseModel as any).data = data;
