...
export async function GET(request, { params }) {
    ...
    if (!id) {
        ...
        (ResponseModel as any).message = 'Invalid Data: Rule ID is required';
    ...
    if (index === null || index === undefined) {
        ...
        (ResponseModel as any).status = '400';
        (ResponseModel as any).message = 'Invalid Data: index query parameter is required';
        (ResponseModel as any).data = null;
        return NextResponse.json(ResponseModel, { status: 400 });
    }
    ...
    if (!data) {
        ...
        (ResponseModel as any).message = `Rule Not Found with ID: ${id} at index: ${index}`;
        (ResponseModel as any).data = null;
...
export async function PUT(request, { params }) {
    ...
    if (!id || !body || !body.hla_gene || !body.drug || !body.typeof_scar || !body.ethnic_group || !body.odds_score || !body.ref || !body.Name) {
        ...
        (ResponseModel as any).status = '400';
        (ResponseModel as any).message = 'Invalid Data - Missing ID or required fields';
        (ResponseModel as any).data = null;
        return NextResponse.json(ResponseModel, { status: 400 });
    }
